...
type V1InstancesAlertconfigsUpdateRequestRoute struct {
	...
	// map of key:value. A set of equality matchers an alert has to fulfill to match the node.
	Match map[string]interface{} `json:"match,omitempty"`
	// map of key:value. A set of regex-matchers an alert has to fulfill to match the node.
